...
class DiscoveryPresentInteractionController: UIPercentDrivenInteractiveTransition {
    ...
    @objc func presentDiscoveryViewController(_ gesture: UIPanGestureRecognizer) {
        ...
        case .began: self.homeViewController.show(self.discoveryViewController, sender: self.homeViewController)
